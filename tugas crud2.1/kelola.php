...
if(isset($_GET['edit'])){
$id_guru =$_GET['edit'];
$sql = "SELECT * FROM daftar WHERE id_guru='$id_guru';";
$query = mysqli_query($db, $sql);
$result =mysqli_fetch_assoc($query);
$nama = $result['nama_guru'];
$jk = $result['jenis_kelamin'];
$alamat = $result['alamat'];
$no = $result['no_telepon'];
$email = $result['email'];
}
?>
<!DOCTYPE html>
...
<div class="mb-3">
    ...
    <input type="number" class ="form-control" name="no_telepon" value="<?php echo $no;?>" placeholder="Nomer Telepon" />
    <div class="mb-3">
